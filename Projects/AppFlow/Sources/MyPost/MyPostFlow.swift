...
class MyPostFlow: Flow {

    var root: Presentable {
        return rootPresentable
    }

    private let rootPresentable: MyPostViewController
    private let container = StepperDI.shared

    public init() {
        self.rootPresentable = MyPostViewController(viewModel: container.myPostViewModel)
    }
    ...
    private func navigateToMyPostScreen() -> FlowContributors {
